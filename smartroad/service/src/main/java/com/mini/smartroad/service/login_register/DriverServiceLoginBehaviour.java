...
public class DriverServiceLoginBehaviour extends BaseInteractBehaviour {

    private boolean sent;

    public DriverServiceLoginBehaviour(AID receiver, String ontology, String protocol, Serializable inputContent) {
    ...
    private LoginRegisterUserOutDto loginUser(UserLoginInDto userLoginInDto, ACLMessage aclMessage) {

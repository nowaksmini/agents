...
public class DriverClientInformServiceInvitationRejectedRequestBehaviour extends BaseDoneBehaviour {

    private ActionInDto actionInDto;

    public DriverClientInformServiceInvitationRejectedRequestBehaviour(ActionInDto actionInDto){
    ...
    public void action() {
        ...
        message.setProtocol(Utils.PROTOCOL_USER_REJECT_INVITATION);
        ((BaseAgent) myAgent).sendMessage(message);
        myAgent.addBehaviour(new DriverClientInformServiceInvitationRejectResponseBehaviour());
        isDone = true;
    }
}

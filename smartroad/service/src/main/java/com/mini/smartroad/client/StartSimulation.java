...
//            AgentController agentControllerRegister = Main.getAgentContainer().createNewAgent(LoginRegisterClientAgent.class.getName() + (1 + 2 * i),
//                    LoginRegisterClientAgent.class.getName(), new String[]{"driver" + i + "@gmail.com",
//                            "driver" + i + "_firstName", "driver" + i + "_lastName", "password"});
//            agentControllerRegister.start();
//            AgentController agentControllerLogin = Main.getAgentContainer().createNewAgent(LoginRegisterClientAgent.class.getName() + (2 + 2 * i),
//                    LoginRegisterClientAgent.class.getName(), new String[]{"driver" + i + "@gmail.com", "password"});
//            agentControllerLogin.start();
//        }
//    }
//

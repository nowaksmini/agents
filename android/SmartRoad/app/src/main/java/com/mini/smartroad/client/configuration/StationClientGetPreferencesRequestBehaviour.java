...
public class StationClientGetPreferencesRequestBehaviour extends BaseDoneBehaviour {

    private BaseInDto baseInDto;

    public StationClientGetPreferencesRequestBehaviour(BaseInDto baseInDto) {
    ...
    public void action() {
        ...
        isDone = true;
        myAgent.addBehaviour(new StationClientGetPreferencesResponseBehaviour());
    }
}

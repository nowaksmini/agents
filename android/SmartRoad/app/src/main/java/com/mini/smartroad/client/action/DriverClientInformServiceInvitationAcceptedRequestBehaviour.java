...
public class DriverClientInformServiceInvitationAcceptedRequestBehaviour extends BaseDoneBehaviour {

    private ActionInDto actionInDto;

    public DriverClientInformServiceInvitationAcceptedRequestBehaviour(ActionInDto actionInDto){
    ...
    public void action() {
        ...
        message.setProtocol(Utils.PROTOCOL_USER_ACCEPT_INVITATION);
        ((BaseAgent) myAgent).sendMessage(message);
        myAgent.addBehaviour(new DriverClientInformServiceInvitationAcceptedResponseBehaviour());
        isDone = true;
    }
}
